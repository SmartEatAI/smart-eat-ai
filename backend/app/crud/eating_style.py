...
def existing_eating_style(db: Session, name: str):
    ...
    try:
        ...
        print(f"Database error when existing_eating_style: {e}")
        raise HTTPException(status_code=500, detail="Database error when existing_eating_style")
...
def get_eating_styles(db: Session):
    ...
    try:
        ...
        print(f"Database error when get_eating_styles: {e}")
        raise HTTPException(status_code=500, detail="Database error when get_eating_styles")
...
def get_eating_style_by_id(db: Session, eating_style_id: int):
    ...
    try:
        ...
        print(f"Database error when get_eating_style_by_id: {e}")
        raise HTTPException(status_code=500, detail="Database error when get_eating_style_by_id")
...
def get_eating_styles_by_profile(db: Session, profile_id: int):
    ...
    try:
        ...
        print(f"Database error when get_eating_styles_by_profile: {e}")
        raise HTTPException(status_code=500, detail="Database error when get_eating_styles_by_profile")
...
def create_eating_style_for_profile(db: Session, obj_in: CategoryBase, profile_id: int):
    ...
    try:
        ...
        print(f"Database error when create_eating_style_for_profile: {e}")
        raise HTTPException(status_code=500, detail="Database error when create_eating_style_for_profile")
...
def add_eating_style_to_profile(db: Session, eating_style_id: int, profile_id: int):
    ...
    try:
        ...
        print(f"Database error when add_eating_style_to_profile: {e}")
        raise HTTPException(status_code=500, detail="Database error when add_eating_style_to_profile")